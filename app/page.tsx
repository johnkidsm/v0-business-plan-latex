...
import { ArrowRight, Shield, Zap, Brain, Satellite, MapPin, Linkedin, Mail, Phone, Github } from "lucide-react"
      ...
      <nav className="border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-2">
              <Link href="https://www.linkedin.com/company/kraftgeneai" target="_blank" rel="noopener noreferrer">
              ...
              <Link href="https://github.com/KraftgeneAI/" target="_blank" rel="noopener noreferrer">
                <Button variant="ghost" size="icon">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Link
                        href="https://www.linkedin.com/company/kraftgeneai"
                        target="_blank"
